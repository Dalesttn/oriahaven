...
$guides = array(
	...
	array(
		...
		'quick_answer' => "For a proper hour off, Body Riches in South Fremantle has a garden room with a private outdoor spa and twenty years behind it. For a body that has stopped cooperating, Your Local Healing Choice assesses first and treats second across Wembley, Subiaco and Nedlands, and MyoCare in Hillarys books long appointments as standard. Subiaco Sports Massage opens early and runs to 8pm on weekdays. Guildford Wellness and MyoFix in Cannington both run HICAPS on site for health-fund rebates.",
		'category'     => 'hands-on',
		'practice'     => 'bodywork',
		'featured'     => true,
		'award'        => 'best_massage',
		'reviewed'     => '2026-09-16',
		'method'       => "We compared Perth practices on publicly available information: the styles each one actually offers, the length of a standard appointment, opening hours including evenings and weekends, whether health-fund rebates can be claimed on the spot, how the practice describes its own approach, and whether a price is published. Nothing here says a massage treats a condition, and nobody on this list was tested by us.",
		'faq'          => array(
			array( 'question' => 'How much does a massage cost in Perth?', 'answer' => 'Most Perth practices charge by the length of the appointment rather than by style, and an hour is the common unit. Only a minority publish a price list, so the guide names a figure where the practice does and stays quiet where it does not — ring ahead rather than assume.' ),
			array( 'question' => 'What is the difference between remedial and relaxation massage?', 'answer' => 'Relaxation massage is a continuous, even treatment over the whole body, and the point is the hour itself. Remedial massage starts with an assessment and works on specific tissue, so it is often slower, firmer and concentrated in one area. Remedial is the one health funds usually recognise.' ),
			array( 'question' => 'Can I claim massage on private health insurance?', 'answer' => 'Remedial massage is claimable on many extras policies when the therapist is registered with a recognised association; relaxation massage generally is not. Several practices in this guide run HICAPS, which means the rebate comes off at the counter. Check your own policy — cover and annual limits vary a lot.' ),
			array( 'question' => 'Do I need a referral for remedial massage?', 'answer' => 'No. Massage is not part of the Medicare referral system in Australia, so you book directly. A referral only matters if you are claiming through a specific scheme such as workers compensation or a care plan.' ),
			array( 'question' => 'Where can I book a couples massage in Perth?', 'answer' => 'Body Riches in South Fremantle has a dedicated couples room with a private outdoor spa. Several day spas also run couples rooms — Annasha in Gooseberry Hill has three of them, and Manusa in East Fremantle and Ganesha in East Perth both do couples treatments.' ),
			array( 'question' => 'How often should I get a massage?', 'answer' => 'There is no schedule that suits everyone, and any practice that gives you one before meeting you is guessing. If you are working on something specific, a remedial therapist will usually suggest a short run of appointments and then reassess. If you simply like it, whatever fits your month is the right answer.' ),
		),
		'links'        => array(
			array( 'label' => 'All massage and bodywork in Perth', 'url' => home_url( '/explore/perth/bodywork/' ) ),
	...
	array(
		...
		'quick_answer' => "Best Body in Bassendean publishes the clearest pricing in Perth — $45 casual, weekly memberships from $48, and a six-week money-back guarantee. For an intro offer, Element in Victoria Park does fourteen days unlimited for $69 and Manna in Guildford does five classes for $55. Reform & Restore in Scarborough caps classes at six reformers and adds a sauna and ice bath. Hills Pilates House in Kalamunda is two weeks unlimited for $75.",
		'category'     => 'move',
		'practice'     => 'fitness',
		'featured'     => true,
		'award'        => 'best_reformer',
		'reviewed'     => '2026-09-16',
		'method'       => "We compared published casual prices, introductory offers, how many reformers a studio puts in a room, the spread of the timetable, and whether beginners get a separate class or an induction. Eight of the eighteen reformer studios in the directory publish a price; the ones that do are easier to compare and that is reflected here. Prices name the month we checked them and studios change them.",
		'faq'          => array(
			array( 'question' => 'How much is reformer Pilates in Perth?', 'answer' => 'Among the studios in this guide that publish a casual rate, it runs from $45 at Best Body in Bassendean upward. Introductory offers are usually the cheaper way in: fourteen days unlimited for $69, two weeks for $75, or five classes for $55. Memberships bring the per-class cost down again.' ),
			array( 'question' => 'What is the best reformer Pilates intro offer in Perth?', 'answer' => 'Manna in Guildford offers five classes for $55, which is the lowest per-class figure here. Element in Victoria Park gives fourteen days unlimited for $69 and Hills Pilates House two weeks for $75 — better value if you can get in three or four times a week.' ),
			array( 'question' => 'Is reformer Pilates suitable for beginners?', 'answer' => 'Yes, and the machine often suits beginners better than mat work because the springs support you. Most studios ask first-timers to do a foundation class or a short induction. Our beginner Pilates guide covers the studios that run those properly.' ),
			array( 'question' => 'How many people are in a reformer class?', 'answer' => 'It varies more than price does, and it changes the class more than price does. Reform & Restore in Scarborough runs a maximum of six. Larger studios run ten to twelve. Small classes mean more correction; larger ones are usually cheaper.' ),
			array( 'question' => 'What should I wear to reformer Pilates?', 'answer' => 'Fitted clothes so the instructor can see how you are moving, and grip socks — most studios require them and will sell you a pair if you forget. Nothing with zips or buckles that could mark the machine.' ),
		),
		'links'        => array(
			array( 'label' => 'All reformer Pilates in Perth', 'url' => home_url( '/explore/perth/fitness/reformer-pilates/' ) ),
			array( 'label' => 'Best Pilates for beginners in Perth', 'url' => home_url( '/best/pilates-for-beginners-perth/' ) ),
			array( 'label' => 'Wellness under $50 in Perth', 'url' => home_url( '/best/wellness-under-50-perth/' ) ),
		),
		'find'         => array( 'specialty' => array( 'reformer-pilates' ) ),
	),
	array(
		...
		'quick_answer' => "For a first day retreat, Kookaburra Yoga runs a monthly one-day silent retreat on ten bushland acres at Bedfordale, and Awakened Wellness runs themed day retreats around Perth with lunch included. Spanda School in Fremantle holds one-day silent sittings in town and three- and seven-day residentials near Pemberton. For a whole property, Redgum Retreat in Dwellingup sleeps eighteen on the Bibbulmun Track and Ikigai at Woodridge sleeps twenty.",
		'category'     => 'experiences',
		'practice'     => 'retreats',
		'featured'     => true,
		'award'        => 'best_retreat',
		'reviewed'     => '2026-09-16',
		'method'       => "We looked at how long each retreat runs, how far it is from Perth, what is included — meals, accommodation, teaching — whether it can be booked by an individual or only by a group, and what the setting actually is. A retreat is a significant amount of money and time, so the guide says plainly which ones you book as one person and which ones you book as a group of eighteen.",
		'faq'          => array(
			array( 'question' => 'What is the difference between a day retreat and a residential retreat?', 'answer' => 'A day retreat runs for one day and you go home at the end of it — usually a single site, a few sessions and a meal. A residential retreat includes accommodation and runs from a weekend upward, which changes it considerably: the quiet compounds overnight, and there is no going back to your own kitchen.' ),
			array( 'question' => 'How much do wellness retreats near Perth cost?', 'answer' => 'A day retreat is typically the price of a very good class plus lunch. Residential retreats scale with the accommodation more than the teaching. Whole-property hire is quoted per night for the building — Serpentine Retreat Centre publishes $500 a night for its cottage, $1,600 for the 23-bed wing and $3,000 for the 46-bed wing.' ),
			array( 'question' => 'Can I go on a retreat by myself?', 'answer' => 'Yes, and several here are built for it. Kookaburra Yoga takes self-guided personal retreat stays, Spanda School\u2019s silent retreats are booked individually, and Nature\u2019s Paradise near Mundaring runs residential programs for adults. The whole-property venues — Redgum, Ikigai, Serpentine — are hired by a group rather than joined as an individual.' ),
			array( 'question' => 'What should I bring to a retreat?', 'answer' => 'Warm layers for sitting still, something to walk in, and less than you think. Most retreats provide mats and props and will send a list. If the retreat is silent, leave the work phone at home rather than in your bag — that is the part people underestimate.' ),
			array( 'question' => 'Are there retreats in the Perth Hills?', 'answer' => 'Several. Kookaburra Yoga is at Bedfordale, Nature\u2019s Paradise is on a hilltop outside Mundaring surrounded by state forest, Ikigai is at Woodridge and Serpentine Retreat Centre is about an hour south-east. Redgum is further out at Dwellingup, on the Bibbulmun Track.' ),
		),
		'links'        => array(
			array( 'label' => 'All retreats and day escapes', 'url' => home_url( '/explore/perth/retreats/' ) ),
			array( 'label' => 'Best places to relax in Perth', 'url' => home_url( '/best/places-to-relax-perth/' ) ),
			array( 'label' => 'Best breathwork classes in Perth', 'url' => home_url( '/best/breathwork-perth/' ) ),
		),
		'find'         => array( 'specialty' => array( 'wellness-retreats' ) ),
	),
	array(
		...
		'quick_answer' => "Baolin on Newcastle Street is the only clinic in the directory publishing a full price list — $95 for an initial acupuncture consultation, $75 after, with HICAPS on the spot and a second clinic in Subiaco. Tao in Shenton Park is run by a practitioner with a PhD and thirty years in clinic. TCM Health Care in Leeming requires every practitioner to have ten years' experience beyond registration. TCM Acupuncture in North Perth runs evenings to 7pm and Saturdays.",
		'category'     => 'hands-on',
		'practice'     => 'natural',
		'featured'     => false,
		'award'        => 'best_acupuncture',
		'reviewed'     => '2026-09-16',
		'method'       => "We compared clinics on objective, checkable things: AHPRA registration, years in clinic, qualifications the practitioner publishes, what is offered alongside acupuncture, opening hours including evenings and weekends, whether online booking exists, and whether health-fund rebates are processed on site. We do not rank practitioners by clinical outcomes, and nothing in this guide says acupuncture treats any condition — that is not a claim a directory is in a position to make.",
		'faq'          => array(
			array( 'question' => 'Is acupuncture regulated in Australia?', 'answer' => 'Yes. Chinese medicine has been a registered profession since 2012, and acupuncturists must be registered with AHPRA to use the title. You can search any practitioner\u2019s name on the AHPRA register yourself and see their registration and any conditions on it. It is worth doing.' ),
			array( 'question' => 'How much does acupuncture cost in Perth?', 'answer' => 'Only one clinic in our directory publishes a full price list: Baolin, at $95 for an initial consultation and $75 for subsequent ones. Most clinics quote on enquiry. Expect an initial appointment to cost more than a follow-up because it includes an assessment, and expect to be asked about your health history at length.' ),
			array( 'question' => 'How long is an acupuncture session?', 'answer' => 'An initial appointment usually runs an hour or more because most of it is the consultation. Follow-ups are commonly thirty to forty-five minutes, part of which is spent resting with the needles in place. Ask when booking — the length varies more between clinics than the price does.' ),
			array( 'question' => 'What should I wear to an acupuncture appointment?', 'answer' => 'Loose clothing that can be rolled above the elbow and knee, since many commonly used points are on the forearms and lower legs. If more access is needed you will be draped, as you would be for a massage.' ),
			array( 'question' => 'Do I need a referral to see an acupuncturist?', 'answer' => 'No. You can book directly. Private health extras cover often applies where the practitioner is registered, and several clinics here process the rebate on the spot through HICAPS. Medicare does not cover acupuncture except in limited circumstances through a GP.' ),
			array( 'question' => 'How do I choose an acupuncturist?', 'answer' => 'Check the AHPRA register, then look at the practical fit: how near the clinic is, whether the hours suit you, whether they speak a language you are comfortable in, and whether they offer the other things you might want alongside — herbal medicine, cupping, massage. A clinic that explains what an appointment involves before you book is a good sign.' ),
		),
		'links'        => array(
			array( 'label' => 'All acupuncture in Perth', 'url' => home_url( '/explore/perth/natural/acupuncture/' ) ),
			array( 'label' => 'Chinese medicine in Perth', 'url' => home_url( '/explore/perth/natural/chinese-medicine/' ) ),
			array( 'label' => 'Best remedial massage in Perth', 'url' => home_url( '/best/remedial-massage-perth/' ) ),
		),
