...
require_once ORIA_CORE_DIR . 'includes/publish-guard.php';
...
require_once ORIA_CORE_DIR . 'includes/event-priority.php';
require_once ORIA_CORE_DIR . 'includes/primary.php';
...
require_once ORIA_CORE_DIR . 'includes/impact-admin.php';
...
require_once ORIA_CORE_DIR . 'includes/listing-editor.php';
require_once ORIA_CORE_DIR . 'includes/listing-search.php';
require_once ORIA_CORE_DIR . 'includes/signup.php';
require_once ORIA_CORE_DIR . 'includes/event-submit.php';
...
require_once ORIA_CORE_DIR . 'includes/area-context.php';
require_once ORIA_CORE_DIR . 'includes/event-collections.php';
require_once ORIA_CORE_DIR . 'includes/event-ics.php';
require_once ORIA_CORE_DIR . 'includes/weekender.php';
require_once ORIA_CORE_DIR . 'includes/event-share.php';
require_once ORIA_CORE_DIR . 'includes/dna.php';
require_once ORIA_CORE_DIR . 'includes/faq.php';
require_once ORIA_CORE_DIR . 'includes/leads.php';
require_once ORIA_CORE_DIR . 'includes/corrections.php';
...
require_once ORIA_CORE_DIR . 'includes/first-visit.php';
require_once ORIA_CORE_DIR . 'includes/lastmod.php';
require_once ORIA_CORE_DIR . 'includes/facet-index.php';
...
require_once ORIA_CORE_DIR . 'includes/explore.php';
...
require_once ORIA_CORE_DIR . 'includes/migrate-explore.php';
...
require_once ORIA_CORE_DIR . 'includes/best-of.php';
require_once ORIA_CORE_DIR . 'includes/activity.php';
require_once ORIA_CORE_DIR . 'includes/passport.php';
require_once ORIA_CORE_DIR . 'includes/recommend.php';
require_once ORIA_CORE_DIR . 'includes/my-oria.php';
...
Audit\bootstrap();
WeakPages\bootstrap();
EventPriority\bootstrap();
Primary\bootstrap();
Reviews\bootstrap();
Ownership\bootstrap();
ListingEditor\bootstrap();
Corrections\bootstrap();
Analytics\bootstrap();
AnalyticsReport\bootstrap();
Impact\bootstrap();
AltText\bootstrap();
ImpactAdmin\bootstrap();
...
Discover\bootstrap();
Events\bootstrap();
AreaContext\bootstrap();
EventCollections\bootstrap();
EventIcs\bootstrap();
Weekender\bootstrap();
EventShare\bootstrap();
Faq\bootstrap();
Leads\bootstrap();
Share\bootstrap();
OgDefault\bootstrap();
