	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'           => 'field_oria_listing_show_experience',
					'name'          => 'listing_show_experience',
					'label'         => 'Show the experience profile on listing pages',
					'type'          => 'true_false',
					'ui'            => 1,
					'default_value' => 1,
					'instructions'  => 'The "The experience" sentence and the Experience DNA bars. Turning this off also hides "Feels like". Clinics (acupuncture, Chinese medicine, physiotherapy, osteopathy, chiropractic and similar) never show a profile, whatever this is set to. A single listing can also be switched off on its own edit screen.',
				),
				array(
					'key'           => 'field_oria_listing_show_feels_like',
					'name'          => 'listing_show_feels_like',
					'label'         => 'Show "Feels like" suggestions on listing pages',
					'type'          => 'true_false',
					'ui'            => 1,
					'default_value' => 1,
					'instructions'  => 'The line that suggests similar kinds of session, such as "Feels like: Day spa, Reiki, Infrared sauna". It is worked out from the kind of session, not from anything the practice offers, so it can read as a claim about the practice. Switch off to remove it from every listing.',
				),
