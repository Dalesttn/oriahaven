...
?>
<section class="wrap section section--top-flush floor catevents" id="events">
	<h2 class="micro floor__label"><?php esc_html_e( "What's on", 'oria' ); ?></h2>
	<div class="guides__head">
		<h2 class="h3">
			<?php
			/* translators: %s: category name, lower case */
			printf( esc_html__( 'Upcoming %s events and workshops', 'oria' ), esc_html( strtolower( $oria_pname ) ) );
			?>
		</h2>
		<?php if ( $oria_all ) : ?>
