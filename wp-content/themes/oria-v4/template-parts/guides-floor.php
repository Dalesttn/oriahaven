...
<?php
/*
 * v4 (child copy of oria/template-parts/guides-floor.php): the "Guides"
 * label is an eyebrow, not a second H2 stacked on the real heading -- the
 * category brief's one-heading rule. Otherwise identical to the parent's.
 */
?>
<section class="wrap section section--top-flush floor<?php echo $oria_compact ? ' guides--compact' : ''; ?>" id="guides" aria-labelledby="guides-title">
	<p class="micro floor__label"><?php esc_html_e( 'Guides', 'oria' ); ?></p>
	<div class="guides__head">
		<h2 class="h3" id="guides-title"><?php echo esc_html( $oria_heading ); ?></h2>
